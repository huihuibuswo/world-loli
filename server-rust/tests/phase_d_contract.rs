...
#[tokio::test]
async fn phase_d_opening_routes_require_authentication() {
    for (method, path) in [
        ("GET", "/api/v1/opening"),
        ("POST", "/api/v1/opening/start"),
        ("POST", "/api/v1/opening/complete"),
        ("POST", "/api/v1/opening/action"),
        ("POST", "/api/v1/opening/moon-trace/action"),
    ] {
